...
```
Where the mg_wrapser_latest.py and parameters_default.txt are the MG Wrapser script and its parameters file respectively. Sample parameter settings and the corresponding instructions could be found in parameters_default.txt file.
